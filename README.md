...
* Отображение распределения разворотов в данных калибровки,
* Ревизия экспорта абрисов в DXF - Опция сплайн интерполяции кривых.
* Поддержка DXF: 9 ACAD1000 и 12 (R13) ACAD1012.
* Поддрежка BRIC4: включен "откат времени" и коды ошибок. (Почти готово)
* Исправления: инкриментальное обновление редукции данных.
