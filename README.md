...
4.1.4v - 2019-10-04
* Исправления: диалог первичной настройки, ориентация экрана, валидация калибровки, легенда и альтитуда, файлв условных обозначаний, импорт VisualTopo, прилипание границ области, экспорт shapefile.
